    ...
    public partial class CreateTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderDetail", x => new { x.Id, x.ProductId, x.OrderId });
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "password123", null, "Admin", "Haggag281" },
                    { 2, "password456", null, "User", "Tarek777" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "smartphone.jpg", "Smartphone", 299f },
                    { 2, 1, "laptop.jpg", "Laptop", 799f },
                    { 3, 2, "novel.jpg", "Novel", 19f },
                    { 4, 3, "tshirt.jpg", "T-Shirt", 9f },
                    { 5, 3, "jeans.jpg", "Jeans", 49f }
                });
