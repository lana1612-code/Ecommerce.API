...
{
    public  class AppDbContext : IdentityDbContext<LocalUser> // IdentityDbContext<LocalUser, IdentityRole<int>, int>
    {
       // private readonly DbContextOptions<AppDbContext> options;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
           ...
           //     new Orders { Id = 3, OrderStatus = "Shipped", OrderDate = new DateTime(2023, 12, 13), LocalUserId = "3" }
           // );
